...
const LandingPage = () => {
  ...
  return (
    <Box sx={{ bgcolor: "background.default", height: "100%", pr: 8, pl: 8 ,pt:8}}>
      <div className="container">
        <div className="upperArea">
          <Search value={search} onChange={(e)=>handleChangeSearch(e)}/>
          <Filter handleChange={handleChange} regionName={regionName} region={coutries}/>
        </div>
